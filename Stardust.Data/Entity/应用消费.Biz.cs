...
namespace Stardust.Data
{
    ...
    public partial class AppConsume : EntityBase<AppConsume>
    {
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            // 检查唯一索引
            // CheckExist(isNew, __.AppID, __.ServiceID);
        }
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化AppConsume[应用消费]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化AppConsume[应用消费]数据！");
        //}
        ...
        [XmlIgnore]
        //[ScriptIgnore]
        public Service Service { get { return Extends.Get(nameof(Service), k => Service.FindByID(ServiceID)); } }

        /// <summary>服务</summary>
        [XmlIgnore]
        //[ScriptIgnore]
        [DisplayName("服务")]
        [Map(__.ServiceID, typeof(Service), "ID")]
        ...
        /// <summary>根据应用、服务查找</summary>
        /// <param name="appid">应用</param>
        /// <param name="serviceid">服务</param>
        /// <returns>实体对象</returns>
        public static AppConsume FindByAppIDAndServiceID(Int32 appid, Int32 serviceid)
        {
            // 实体缓存
            if (Meta.Session.Count < 1000) return Meta.Cache.Find(e => e.AppID == appid && e.ServiceID == serviceid);

            return Find(_.AppID == appid & _.ServiceID == serviceid);
        }
        #endregion
