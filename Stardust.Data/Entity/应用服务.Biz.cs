...
namespace Stardust.Data
{
    ...
    public partial class AppService : EntityBase<AppService>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化AppService[应用服务]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化AppService[应用服务]数据！");
        //}
        ...
        /// <returns>实体对象</returns>
        public static AppService FindByAppIDAndServiceID(Int32 appid, Int32 serviceid)
        {
            // 实体缓存
