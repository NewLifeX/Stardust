...
namespace Stardust.Data
{
    ...
    public partial class AppStat : EntityBase<AppStat>
    {
        #region 对象操作
        static AppStat()
        {
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            // 检查唯一索引
            // CheckExist(isNew, __.AppID, __.Level, __.Time);
        }
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化AppStat[应用统计]数据……");

        //    var entity = new AppStat();
        //    entity.ID = 0;
        //    entity.AppID = 0;
        //    entity.Level = 0;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化AppStat[应用统计]数据！");
        //}
        ...
        public static AppStat FindByID(Int32 id)
        {
            if (id <= 0) return null;
