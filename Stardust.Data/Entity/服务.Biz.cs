...
namespace Stardust.Data
{
    ...
    public partial class Service : EntityBase<Service>
    {
        #region 对象操作
        static Service()
        {
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            if (ServiceType.IsNullOrEmpty()) throw new ArgumentNullException(nameof(ServiceType), "服务类型不能为空！");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化Service[服务]数据……");

        //    var entity = new Service();
        //    entity.ID = 0;
        //    entity.Name = "abc";
        //    entity.ServiceType = "abc";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化Service[服务]数据！");
        //}
        ...
        public static Service FindByName(String name)
        {
            ...
            // 单对象缓存
            //return Meta.SingleCache.GetItemWithSlaveKey(name) as Service;
