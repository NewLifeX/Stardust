...
public partial class AppService
{
    ...
    public static IList<AppService> Search(Int32 appId, Int32 serviceId, Int32 nodeId, Boolean? healthy, Boolean? enable, DateTime start, DateTime end, String key, PageParameter page)
    {
