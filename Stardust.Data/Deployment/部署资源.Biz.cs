...
public partial class AppResource : Entity<AppResource>
{
    #region 对象操作
    ...
    public override Boolean Valid(DataMethod method)
    {
        ...
        // 检查唯一索引
        // CheckExist(method == DataMethod.Insert, nameof(DeployId), nameof(Name));
    ...
    //    if (XTrace.Debug) XTrace.WriteLine("开始初始化AppResource[部署资源]数据……");
    ...
    //    entity.UnZip = true;
    //    entity.Overwrite = "abc";
    //    entity.Insert();

    //    if (XTrace.Debug) XTrace.WriteLine("完成初始化AppResource[部署资源]数据！");
    //}
    ...
    public static AppResource FindByName(String name)
    {
