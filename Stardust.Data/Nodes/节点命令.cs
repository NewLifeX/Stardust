...
public partial class NodeCommand
{
    ...
    /// <param name="nodeId">节点</param>
    /// <returns>实体列表</returns>
    public static IList<NodeCommand> FindAllByNodeID(Int32 nodeId)
    {
        if (nodeId < 0) return [];
    ...
    /// <returns>实体列表</returns>
    public static IList<NodeCommand> Search(Int32 nodeId, NewLife.Remoting.Models.CommandStatus status, DateTime start, DateTime end, String key, PageParameter page)
    {
