...
namespace Stardust.Data.Nodes
{
    ...
    public partial class NodeVersion
    {
        ...
        /// <summary>策略。升级策略，node=abcd;version=1.0,1.1;runtime=5.0.*;province=31*;city=4509*</summary>
        [DisplayName("策略")]
        [Description("策略。升级策略，node=abcd;version=1.0,1.1;runtime=5.0.*;province=31*;city=4509*")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn("Strategy", "策略。升级策略，node=abcd;version=1.0,1.1;runtime=5.0.*;province=31*;city=4509*", "")]
