...
namespace Stardust.Data.Nodes
{
    ...
    public partial class RedisMessageQueue : Entity<RedisMessageQueue>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化RedisMessageQueue[Redis消息队列]数据……");

        //    var entity = new RedisMessageQueue();
        //    entity.Id = 0;
        //    entity.RedisId = 0;
        //    entity.Name = "abc";
        //    entity.Db = 0;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化RedisMessageQueue[Redis消息队列]数据！");
        //}
        ...
        public static RedisMessageQueue FindById(Int64 id)
        {
            if (id <= 0) return null;
