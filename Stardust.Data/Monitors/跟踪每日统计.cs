...
public partial class TraceDayStat
{
    ...
    /// <param name="appId">应用</param>
    /// <param name="itemId">跟踪项</param>
    /// <param name="type">种类。Api/Http/Db/Mq/Redis/Other</param>
    /// <param name="start">统计日期开始</param>
    /// <param name="end">统计日期结束</param>
    /// <param name="key">关键字</param>
    /// <param name="page">分页参数信息。可携带统计和数据权限扩展查询等信息</param>
    /// <returns>实体列表</returns>
    public static IList<TraceDayStat> Search(Int32 appId, Int32 itemId, String type, DateTime start, DateTime end, String key, PageParameter page)
    {
