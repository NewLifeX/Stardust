...
namespace Stardust.Data.Monitors
{
    ...
    public partial class AlarmGroup : Entity<AlarmGroup>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化AlarmGroup[告警组]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化AlarmGroup[告警组]数据！");
        //}
        ...
        // Select Count(Id) as Id,Category From AlarmGroup Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<AlarmGroup> _CategoryCache = new FieldCache<AlarmGroup>(nameof(Category))
        //{
