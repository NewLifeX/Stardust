...
public partial class SampleData
{
    ...
    /// <param name="traceId">追踪。可用于关联多个片段，建立依赖关系，随线程上下文、Http、Rpc传递</param>
    /// <param name="success">正常</param>
    /// <param name="start">编号开始</param>
    /// <param name="end">编号结束</param>
    /// <param name="key">关键字</param>
    /// <param name="page">分页参数信息。可携带统计和数据权限扩展查询等信息</param>
    /// <returns>实体列表</returns>
    public static IList<SampleData> Search(Int64 dataId, String traceId, Boolean? success, DateTime start, DateTime end, String key, PageParameter page)
    {
