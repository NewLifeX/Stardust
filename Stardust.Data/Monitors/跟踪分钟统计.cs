...
[BindTable("TraceMinuteStat", Description = "跟踪分钟统计。每应用每接口每5分钟统计，用于分析接口健康状况", ConnName = "StardustData", DbType = DatabaseType.None)]
public partial class TraceMinuteStat
{
    ...
    /// <returns>实体列表</returns>
    public static IList<TraceMinuteStat> Search(Int32 appId, Int32 itemId, DateTime start, DateTime end, String key, PageParameter page)
    {
    ...
    public static Int32 DeleteWith(DateTime start, DateTime end, Int32 maximumRows = 0)
    {
        ...
        return Delete(_.StatTime.Between(start, end), maximumRows);
    }
    #endregion
