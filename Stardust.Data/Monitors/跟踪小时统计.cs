...
public partial class TraceHourStat
{
    ...
    [BindColumn("StatTime", "统计小时", "", DataScale = "time:yyyy-MM-dd HH")]
    ...
    /// <returns>实体列表</returns>
    public static IList<TraceHourStat> Search(Int32 appId, Int32 itemId, DateTime start, DateTime end, String key, PageParameter page)
    {
