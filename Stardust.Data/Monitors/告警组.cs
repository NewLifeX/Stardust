...
public partial class AlarmGroup
{
    ...
    public static IList<AlarmGroup> Search(Int32 projectId, Boolean? enable, DateTime start, DateTime end, String key, PageParameter page)
    {
    ...
    #region 字段名
    /// <summary>取得告警组字段信息的快捷方式</summary>
    ...
    /// <summary>取得告警组字段名称的快捷方式</summary>
