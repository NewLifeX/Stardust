...
namespace Stardust.Data.Configs
{
    ...
    public partial class AppQuote : Entity<AppQuote>
    {
        #region 对象操作
        static AppQuote()
        {
        ...
        public static AppQuote FindById(Int32 id)
        {
            if (id <= 0) return null;
        ...
        public static IList<AppQuote> FindAllByAppId(Int32 appId)
        {
            // 实体缓存
        ...
        /// <summary>根据目标应用查找</summary>
        /// <param name="targetAppId">目标应用</param>
        /// <returns>实体列表</returns>
        public static IList<AppQuote> FindAllByTargetAppId(Int32 targetAppId)
        {
            // 实体缓存
            if (Meta.Session.Count < 1000) return Meta.Cache.FindAll(e => e.TargetAppId == targetAppId);

            return FindAll(_.TargetAppId == targetAppId);
        }
        #endregion
        ...
        // Select Count(Id) as Id,Category From AppQuote Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<AppQuote> _CategoryCache = new FieldCache<AppQuote>(nameof(Category))
        //{
