...
public partial class ConfigHistory
{
    ...
    /// <returns>实体列表</returns>
    public static IList<ConfigHistory> Search(Int32 configId, Boolean? success, DateTime start, DateTime end, String key, PageParameter page)
    {
    ...
    public static Int32 DeleteWith(DateTime start, DateTime end, Int32 maximumRows = 0)
    {
        ...
        return Delete(_.CreateTime.Between(start, end), maximumRows);
    }
    #endregion
