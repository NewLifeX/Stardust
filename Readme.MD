...
| [功能清单](Doc/功能清单.md) | 全部功能实现/测试/注释状态追踪（v2.0） |
| [架构设计](Doc/架构设计.md) | 架构文档总索引，链接各组件架构（v2.0） |

### 🏗️ 主要组件架构
| 文档 | 说明 |
|------|------|
| [StarServer 架构](Doc/StarServer架构.md) | 服务端核心（应用/配置/注册/日志/平台/基础能力） |
| [M5-StarAgent 架构](Doc/M5-StarAgent架构.md) | 节点代理守护/监控/发布 |
| [M1-SDK 架构](Doc/M1-SDK架构.md) | 客户端 SDK（配置/追踪/注册发现） |
| [M8-监控系统架构](Doc/M8-监控系统架构.md) | APM 监控子系统详细架构 |
| [M10-远程发布架构](Doc/M10-远程发布架构.md) | 远程发布子系统详细架构 |
| [M11-网关架构](Doc/M11-网关架构.md) | 网关总架构 |

### 🔧 子模块文档
| 文档 | 说明 |
|------|------|
| [M5-9-指令下发](Doc/M5-9-指令下发.md) | M5-9 命令下发流程（WebSocket 双通道） |
| [M8-3-链路追踪统计](Doc/M8-3-链路追踪统计.md) | M8-3 追踪统计性能瓶颈与优化 |
| [M5-15-StarAgent远程部署](Doc/M5-15-StarAgent远程部署.md) | M5-15 远程部署方案 |
| [M5-16-阿里云DNS动态域名解析](Doc/M5-16-阿里云DNS动态域名解析.md) | M5-16 动态域名解析 |
| [M5-14-防火墙管理](Doc/M5-14-防火墙管理.md) | M5-14 防火墙端口管理 |
| [M10-21-分布式文件存储](Doc/M10-21-分布式文件存储.md) | 文件存储设计 |
| [M10-19-应用包规范](Doc/M10-19-应用包规范.md) | 应用包格式与规范 |
| [M2-8-远程命令执行安全](Doc/M2-8-远程命令执行安全.md) | 安全方案 |
| [M10-20-部署代理](Doc/M10-20-部署代理.md) | 部署代理使用说明 |
| [M11-8-网关使用指南](Doc/M11-8-网关使用指南.md) | 网关使用说明 |
