...
| 文档 | 说明 |
|------|------|
| [StarServer 架构](Doc/M0-StarServer架构.md) | 服务端核心（应用/配置/注册/日志/平台） |
| [StarAgent 架构](Doc/M1-StarAgent架构.md) | 节点代理守护/监控/发布 |
| [SDK 架构](Doc/M11-SDK架构.md) | 客户端 SDK（配置/追踪/注册发现） |
| [M5-监控系统架构](Doc/M5-监控系统架构.md) | APM 监控子系统详细架构 |
| [M7-远程发布架构](Doc/M7-远程发布架构.md) | 远程发布子系统详细架构 |
| [M8-网关架构](Doc/M8-网关架构.md) | 网关总架构 |

### 🔧 子模块文档
| 文档 | 说明 |
|------|------|
| [M1-9-指令下发](Doc/M1-9-指令下发.md) | M1-9 命令下发流程（WebSocket 双通道） |
| [M5-3-链路追踪统计](Doc/M5-3-链路追踪统计.md) | M5-3 追踪统计性能瓶颈与优化 |
| [M1-15-StarAgent远程部署](Doc/M1-15-StarAgent远程部署.md) | M1-15 远程部署方案 |
| [M1-16-阿里云DNS动态域名解析](Doc/M1-16-阿里云DNS动态域名解析.md) | M1-16 动态域名解析 |
| [M1-14-防火墙管理](Doc/M1-14-防火墙管理.md) | M1-14 防火墙端口管理 |
| [M7-21-分布式文件存储](Doc/M7-21-分布式文件存储.md) | 文件存储设计 |
| [M7-19-应用包规范](Doc/M7-19-应用包规范.md) | 应用包格式与规范 |
| [M12-8-远程命令执行安全](Doc/M12-8-远程命令执行安全.md) | 安全方案 |
| [M7-20-部署代理](Doc/M7-20-部署代理.md) | 部署代理使用说明 |
| [M8-8-网关使用指南](Doc/M8-8-网关使用指南.md) | 网关使用说明 |
...
10. [x] 阿里云DNS。StarAgent支持动态域名解析(DDNS)，自动将节点公网IP注册到阿里云DNS，适用于动态IP环境 [详细文档](Doc/M1-16-阿里云DNS动态域名解析.md)  
