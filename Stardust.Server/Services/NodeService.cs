...
namespace Stardust.Server.Services
{
    public class NodeService
    {
        ...
        public TokenModel Login(Node node, LoginInfo inf, String ip)
        {
            ...
            // 设置令牌
            var tokenModel = IssueToken(node.Code, Setting.Current);
        ...
        #region 心跳
        public PingResponse Ping(Node node, PingInfo inf, String token, String ip)
        {
